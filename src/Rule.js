...
class Rule {
    constructor(type) {
        ...
        this.typesSuffixes = { ...defaultTypesSuffixes };
    }
    ...
    generate() {
        ...
        const reducerTemp = this.generateReducer(this.type, this.lowerCamelCaseType, this.typesSuffixes);
